    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        /* binding.tvEdit.setOnClickListener {
             val bundle = Bundle().apply {
                 putLong(PLAYLIST_ID, playlistId ?: -1) // Предотвратите передачу null
             }
             findNavController().navigate(
                 R.id.action_favoriteFragment_to_EditPlaylistFragment,
                 bundle
             )
         }*/
 ...
 */
    ...
    companion object {
        ...
        fun newInstance(playlistId: Long): InfoOfPlaylistsFragment {
            return InfoOfPlaylistsFragment().apply {
